...
export const Contactdetail = () => {
    ...
    return (
      ...
      <div className="contact__detail"> <img className="icon" src="../src/assets/images/newuser-icon.png"></img> <p> {contact.name}</p> </div>
      <div className="contact__detail"><img className="icon" src="../src/assets/images/newphone-icon.png"></img> <p>{contact.number}</p></div>
      </div>
