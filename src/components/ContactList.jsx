  ...
  return (
    ...
    <div >
      {contacts.map(({ id, name, number }) => (
        ...
        <Button btnText={<img className="icon" src="../src/assets/images/edit-icon.png"></img>} cssClass="icon__btn" clickHandler={()=>{editHandler(id)}}></Button>

        <Button btnText={<img className="icon" src="../src/assets/images/bin-icon.png"></img>} cssClass="icon__btn" clickHandler={()=>{deleteHandler(id)}}>  </Button>
        </div>
